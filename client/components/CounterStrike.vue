      ...
      <div class="block_text_block_cs">
            ...
            <div class="text_block_jeux">
              <template v-if="!vraioufaux">
                ...
                <button v-on:click="addToListGames(5)" type="submit" class="btn max_width1 effect01" style="margin-bottom: 10px;" data-aos="fade-up" data-aos-anchor-placement="bottom-bottom" data-aos-delay="100" data-aos-once="true"><span>Favori</span></button>
                </template>
                <template v-else>
                ...
                <button v-on:click="deleteFromListGames(5)" type="submit" class="btn max_width1 effect01" style="margin-bottom: 10px;" data-aos="fade-up" data-aos-anchor-placement="bottom-bottom" data-aos-delay="100" data-aos-once="true"><span>Supprimer</span></button>
              </template>
                ...
                <button v-on:click="navigate(5)" type="submit" class="btn max_width1 effect01" style="margin-bottom: 10px;" data-aos="fade-up" data-aos-anchor-placement="bottom-bottom" data-aos-delay="400" data-aos-once="true"><span>Joueurs</span></button>
            </div>
            </div>
        </div>
